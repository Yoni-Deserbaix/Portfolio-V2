...
export const projectsData: Project[] = [
  ...
  },
  {
    ...
    description: "Une landing page attrayante pour le restaurant FOODLAND, développée avec SASS. Explorez les plats et découvrez les spécialités du restaurant.",
